...
<body>
    <nav class="bg-white border-red-200 dark:bg-gray-900 shadow-md">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center md:order-2 space-x-3 rtl:space-x-reverse">
                ...
                {{-- dropdown --}}
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user_dropdown">
                    <div class="px-4 py-3">
                        <span class="block-text-sm text-gray-900 dark:text-white">{{ $user->user->name }}</span>
                        <span class="block text-sm text-gray-500 truncate dark:text-gray-400">{{ $user->user->name }}</span>
                    </div>
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        ...
                        <li>
                            <form action="{{ route('logout') }}" method="post" id="logout-form" class="inline">
                                @csrf
                                <a href="#" title=""
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-whit"
...
<main class="container mx-auto">
    <div class="px-3 mt-3 p-4">
        <!-- Card header -->
        <div class="items-center justify-between lg:flex">
            <div class=" mb-4 lg:mb-0">
                <h3 class="mb-2 text-xl font-bold text-gray-900">Riwayat Transaksi</h3>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                            ...
                            <tbody class="bg-white dark:bg-gray-800">
                                <tr>
                                    ...
                                    <td
                                        class="p-4 text-sm font-normal text-gray-700 whitespace-nowrap">
                                        Level A
                                    </td>
                                    <td
                                        class="p-4 text-sm font-semibold text-gray-700 whitespace-nowrap">
                                        Rp. 300.000
                                    </td>
                                    <td
                                        class="p-4 text-sm font-normal text-gray-700 whitespace-nowrap">
                                    ...
                                    <td>
                                        <button type="button" class="px-3 py-2 text-sm font-medium text-center text-gray-700 bg-indigo-300 rounded-lg">
                                        Invoice
                                        </button>
                                    </td>
                                </tr>
