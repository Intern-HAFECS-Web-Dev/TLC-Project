...
@section('content')
    ...
    <div class="grid gap-4 px-4 mb-4 md:grid-cols-2 xl:grid-cols-4 xl:px-0">
        <div
            ...
            <div class="px-4 py-2 text-biru bg-greys rounded-sm text-lg font-semibold border dark:border-gray-600">
                <h3>Video Tutorials</h3>
            </div>
            <div class="h-16 px-4 py-20 text-gray-400 border border-gray-200 border-dashed rounded dark:border-gray-600">
                <h3>Card body</h3>
            </div>
