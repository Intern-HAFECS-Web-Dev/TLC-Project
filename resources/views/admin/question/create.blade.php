...
@section('content')
    <div class="p-4 mt-8">
        ...
        <main class="mx-auto border-2 p-3 border-gray-400 mb-10 rounded-md">
                <div class="bg-white">
                    ...
                    <div class="flex flex-col items-center my-3">
                        ...
                        <form action="{{ route('admin.categori.questions.store', $categori) }}" method="POST" id="add-question" class="flex flex-col gap-5">
                            @csrf
                            ...
                            <div class="flex flex-col gap-[10px]">
                                ...
                                @foreach (range('A', 'D') as $i => $letter) 
                                    <div class="flex items-center gap-4">
                                        <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] gap-x-2 rounded-full border border-[#cfcece] focus-within:border-2 focus-within:border-[#0A090B]">
