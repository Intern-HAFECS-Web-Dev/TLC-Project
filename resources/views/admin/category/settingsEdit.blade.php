    ...
    <div class="grid grid-cols-1 px-4 pt-6 mt-4 3xl:grid-cols-3 3xl:gap-4 dark:bg-gray-900">
        ...
        <div class="col-span-2">
            <div class="flex items-center justify-between p-2 mb-4 col-span-full xl:mb-2 bg-biru rounded-xl">
                ...
                <h1 class="mr-4 text-xl font-semibold text-white sm:text-2xl dark:text-white">EDIT NEW LEVELS</h1>
            </div>
            <div
                    ...
                    @method('PUT')
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                required placeholder="Input Nama Levels" value="{{ $levels->name }}">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="number" name="duration" id="duration"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Input Nama Gelar" value="{{ $levels->duration }}">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="benefit" id="benefit"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Input Benefit yang didapatkan" value="{{ $levels->benefit }}">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="condition" id="condition"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Input Persyaratan yang diperlukan" value="{{ $levels->condition }}">
